...
{
	handshake_event(sm->handshake, HANDSHAKE_EVENT_SAE_FAILED, &reason);
...
void sae_register(struct sae_sm *sm)
{
	...
	handshake_event(sm->handshake, HANDSHAKE_EVENT_SAE_STARTED, NULL);
}
